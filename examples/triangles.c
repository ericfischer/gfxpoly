...
char colors[] = { 0,   0,   0,   255, 255, 255, 255, 0,   0,   0,  255, 255, 255, 0,
                  255, 0,   255, 255, 0,   0,   255, 255, 255, 0,  128, 128, 0,   64,
                  64,  0,   255, 128, 128, 64,  64,  64,  96,  96, 96,  128, 255, 128,
                  128, 128, 255, 128, 128, 128, 32,  0,   0,   32, 0,   0 };

typedef struct _xy { double x, y; } xy_t;

typedef struct _triangle { xy_t p1, p2, p3; } triangle_t;
...
int main(int argn, char* argv[]) {
    ...
    int i;
    for (i = 0; i < 16384; i++) {
        rpix[i].x = lrand48() % 640 - 320, rpix[i].y = lrand48() % 480 - 240;
    }
